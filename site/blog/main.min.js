...
!(function (o) {
  ...
  (function (d, s) {
    ...
    (n.prototype.init = function () {
      var t,
        ...
        e = d(this.element),
        a = this.settings;
      a.duplicate ? (o.mobileNav = e.clone()) : (o.mobileNav = e),
        a.removeIds &&
          (o.mobileNav.removeAttr("id"),
          o.mobileNav.find("*").each(function (t, e) {
            d(e).removeAttr("id");
          })),
        a.removeClasses &&
          (o.mobileNav.removeAttr("class"),
          o.mobileNav.find("*").each(function (t, e) {
            d(e).removeAttr("class");
          })),
        a.removeStyles &&
          (o.mobileNav.removeAttr("style"),
          o.mobileNav.find("*").each(function (t, e) {
            d(e).removeAttr("style");
          })),
        (t = p + "_icon"),
        "" === a.label && (t += " " + p + "_no-text"),
        "a" == a.parentTag && (a.parentTag = 'a href="#"'),
        o.mobileNav.attr("class", p + "_nav"),
        (i = d('<div class="' + p + '_menu"></div>')),
        "" !== a.brand &&
          ((e = d('<div class="' + p + '_brand">' + a.brand + "</div>")),
          d(i).append(e)),
        (o.btn = d(
          [
            "<" +
              ...
              p +
              '_collapsed">',
            '<span class="' + p + '_menutxt">' + a.label + "</span>",
            '<span class="' + t + '">',
            '<span class="' + p + '_icon-bar"></span>',
            '<span class="' + p + '_icon-bar"></span>',
            '<span class="' + p + '_icon-bar"></span>',
            "</span>",
            "</" + a.parentTag + ">",
        ...
        d(i).append(o.btn),
        "" !== a.appendTo ? d(a.appendTo).append(i) : d(a.prependTo).prepend(i),
        i.append(o.mobileNav);
      var i = o.mobileNav.find("li");
      d(i).each(function () {
        var t,
          e,
          i,
          s = d(this),
          n = {};
        (n.children = s.children("ul").attr("role", "menu")),
          s.data("menu", n),
          0 < n.children.length
            ? ((i = s.contents()),
              (t = !1),
              ...
              d(i).each(function () {
                return (
                  !d(this).is("ul") &&
                  (e.push(this), void (d(this).is("a") && (t = !0)))
                );
              }),
              (n = d(
                "<" +
              ...
              a.allowParentLinks && !a.nestedParentLinks && t
                ? d(e)
                    .wrapAll(
                      '<span class="' + p + "_parent-link " + p + '_row"/>'
                    )
                    .parent()
                : d(e)
                    .wrapAll(n)
              ...
              a.showChildren
                ? s.addClass(p + "_open")
                : s.addClass(p + "_collapsed"),
              s.addClass(p + "_parent"),
              (i = d(
                '<span class="' +
                  p +
                  '_arrow">' +
              ...
              a.allowParentLinks &&
                ...
                (i = i.wrap(n).parent()),
              d(e).last().after(i))
            : 0 === s.children().length && s.addClass(p + "_txtnode"),
          s
            .children("a")
            .attr("role", "menuitem")
            .click(function (t) {
          ...
          a.closeOnClick &&
            ...
            s
              .find("." + p + "_parent-link a:not(." + p + "_item)")
              .click(function (t) {
                d(o.btn).click();
              }));
      }),
        d(i).each(function () {
          var t = d(this).data("menu");
        ...
        d(o.btn).click(function (t) {
          t.preventDefault(), o._menuToggle();
        }),
        o.mobileNav.on("click", "." + p + "_item", function (t) {
          t.preventDefault(), o._itemClick(d(this));
        }),
        d(o.btn).keydown(function (t) {
          var e = t || event;
          switch (e.keyCode) {
            case l:
            case g:
            case r:
              t.preventDefault(),
                (e.keyCode === r && d(o.btn).hasClass(p + "_open")) ||
                  o._menuToggle(),
                d(o.btn).next().find('[role="menuitem"]').first().focus();
          }
        }),
        o.mobileNav.on("keydown", "." + p + "_item", function (t) {
          switch ((t || event).keyCode) {
            case l:
              t.preventDefault(), o._itemClick(d(t.target));
              break;
            case u:
              t.preventDefault(),
                d(t.target)
                  .parent()
                  .hasClass(p + "_collapsed") && o._itemClick(d(t.target)),
                d(t.target).next().find('[role="menuitem"]').first().focus();
          }
        }),
            ...
            case c:
              t.preventDefault(),
                d(t.target)
                  ...
                  .parent()
                  .hasClass(p + "_open")
                  ? ((s = d(t.target).parent().parent().prev()).focus(),
                    o._itemClick(s))
                  : d(t.target)
                      .parent()
                      .parent()
                      .hasClass(p + "_nav") &&
                    (o._menuToggle(), d(o.btn).focus());
              break;
            case h:
              t.preventDefault(), o._menuToggle(), d(o.btn).focus();
          }
        }),
        a.allowParentLinks &&
          a.nestedParentLinks &&
          d("." + p + "_item a").click(function (t) {
      ...
      (n.prototype._menuToggle = function (t) {
        var e = this.btn,
          i = this.mobileNav;
        e.hasClass(p + "_collapsed")
          ? (e.removeClass(p + "_collapsed"), e.addClass(p + "_open"))
          : (e.removeClass(p + "_open"), e.addClass(p + "_collapsed")),
          e.addClass(p + "_animating"),
          this._visibilityToggle(i, e.parent(), !0, e);
      }),
      (n.prototype._itemClick = function (t) {
        var e = this.settings,
          i = t.data("menu");
        i ||
          (((i = {}).arrow = t.children("." + p + "_arrow")),
          (i.ul = t.next("ul")),
          (i.parent = t.parent()),
          i.parent.hasClass(p + "_parent-link") &&
            ((i.parent = t.parent().parent()), (i.ul = t.parent().next("ul"))),
          t.data("menu", i)),
          i.parent.hasClass(p + "_collapsed")
            ? (i.arrow.html(e.openedSymbol),
              i.parent.removeClass(p + "_collapsed"),
              i.parent.addClass(p + "_open"))
            : (i.arrow.html(e.closedSymbol),
      ...
      (n.prototype._visibilityToggle = function (i, t, e, s, n) {
        function o(t, e) {
        ...
        function a(t, e) {
          i.attr("aria-hidden", "true"),
            ...
            d(t).removeClass(p + "_animating"),
            d(e).removeClass(p + "_animating"),
            n ? "init" == t && l.init() : l.afterClose(t);
        }
        var r = this,
          l = r.settings,
          h = r._getActionItems(i),
          c = 0;
        e && (c = l.duration),
          i.hasClass(p + "_hidden")
            ? (i.removeClass(p + "_hidden"),
              n || l.beforeOpen(s),
              "jquery" === l.animations
                ? i.stop(!0, !0).slideDown(c, l.easingOpen, function () {
                    o(s, t);
                  })
                : "velocity" === l.animations &&
              ...
              h.attr("tabindex", "0"),
              r._setVisAttr(i, !1))
            : (i.addClass(p + "_hidden"),
              n || l.beforeClose(s),
              "jquery" === l.animations
                ? i
                    .stop(!0, !0)
                    .slideUp(c, this.settings.easingClose, function () {
                      a(s, t);
                    })
                : "velocity" === l.animations &&
      ...
      (n.prototype._setVisAttr = function (t, e) {
        var i = this,
          t = t
            .children("li")
            .children("ul")
        ...
        e
          ? t.each(function () {
              ...
              t.attr("aria-hidden", "true"),
                i._getActionItems(t).attr("tabindex", "-1"),
                i._setVisAttr(t, e);
            })
          : t.each(function () {
              var t = d(this);
              t.attr("aria-hidden", "false"),
                i._getActionItems(t).attr("tabindex", "0"),
                i._setVisAttr(t, e);
            });
      }),
      (n.prototype._getActionItems = function (t) {
        ...
        return (
          s ||
            ((s = {}),
            (i = (e = t.children("li")).find("a")),
            (s.links = i.add(e.find("." + p + "_item"))),
            t.data("menu", s)),
          s.links
        );
      }),
      (n.prototype._outlines = function (t) {
        t
          ? d("." + p + "_item, ." + p + "_btn").css("outline", "")
          : d("." + p + "_item, ." + p + "_btn").css("outline", "none");
      }),
        ...
        return void 0 === e || "object" == typeof e
          ? this.each(function () {
              d.data(this, "plugin_" + o) ||
                d.data(this, "plugin_" + o, new n(this, e));
            })
          : "string" == typeof e && "_" !== e[0] && "init" !== e
          ? (this.each(function () {
              var t = d.data(this, "plugin_" + o);
              t instanceof n &&
                "function" == typeof t[e] &&
                (i = t[e].apply(t, Array.prototype.slice.call(s, 1)));
            }),
            void 0 !== i ? i : this)
          : void 0;
      });
    ...
    var e = (function (r, I) {
      ...
      if (I.getElementsByClassName) {
        var L,
          ...
          B = I.documentElement,
          l = r.Date,
          s = r.HTMLPictureElement,
          h = "addEventListener",
          H = "getAttribute",
          c = r[h],
          W = r.setTimeout,
          d = r.requestAnimationFrame || W,
          ...
          F = function (t, e) {
            var i;
            (i = V(t, e)) &&
              t.setAttribute("class", (t[H]("class") || "").replace(i, " "));
          },
          Z = function (e, i, t) {
          ...
          G = (function () {
            var i,
              ...
              a = function () {
                var t = o;
                for (o = e.length ? n : e, i = !0, s = !1; t.length; )
                  t.shift()();
                i = !1;
              },
              t = function (t, e) {
        ...
        !(function () {
          ...
          O = r.lazySizesConfig || r.lazysizesConfig || {};
        ...
        var t = (function () {
            var u,
              ...
              o = /^img$/i,
              p = /^iframe$/i,
              x = "onscroll" in r && !/(gle|ing)bot/.test(navigator.userAgent),
              z = 0,
              k = 0,
              $ = 0,
              T = -1,
              S = function (t) {
                $--,
                  t && t.target && Z(t.target, S),
                  (!t || $ < 0 || !t.target) && ($ = 0);
              },
              E = function (t) {
                return (
                  null == C && (C = "hidden" == X(I.body, "visibility")),
                  C ||
              ...
              M = function (t, e) {
                ...
                for (
                  _ -= e, b += e, y -= e, w += e;
                  n && (s = s.offsetParent) && s != I.body && s != B;
              ...
              t = function () {
                var t,
                  ...
                  d,
                  p = L.elements;
                if ((m = O.loadMode) && $ < 8 && (t = p.length)) {
                  for (
                    e = 0,
                      T++,
                      h =
                        !O.expand || O.expand < 1
                          ? B.clientHeight > 500 && B.clientWidth > 500
                            ? 500
                            : 370
                          : O.expand,
                      c = h * O.expFactor,
              ...
              i = K(t),
              A = function (t) {
                q(t.target, O.loadedClass),
                  F(t.target, O.loadingClass),
                  Z(t.target, D),
                  U(t.target, "lazyloaded");
              },
              s = J(A),
              D = function (t) {
                s({ target: t.target });
              ...
              N = function (t) {
                var e,
                  i = t[H](O.srcsetAttr);
                (e = O.customMedia[t[H]("data-media") || t[H]("media")]) &&
                  t.setAttribute("media", e),
                  i && t.setAttribute("srcset", i);
              },
              a = J(function (t, e, i, s, n) {
                var o, a, r, l, h, c;
                (h = U(t, "lazybeforeunveil", e)).defaultPrevented ||
                  (s &&
                    (i ? q(t, O.autosizesClass) : t.setAttribute("sizes", s)),
                  (a = t[H](O.srcsetAttr)),
                  (o = t[H](O.srcAttr)),
                  n &&
                    ((r = t.parentNode), (l = r && R.test(r.nodeName || ""))),
                  ...
                  c &&
                    ...
                    q(t, O.loadingClass),
                    Z(t, D, !0)),
                  l && Q.call(r.getElementsByTagName("source"), N),
                  a
                    ? t.setAttribute("srcset", a)
                    : o && !l && (p.test(t.nodeName) ? P(t, o) : (t.src = o)),
                  n && (a || l) && Y(t, { src: o })),
                  t._lazyRace && delete t._lazyRace,
                  F(t, O.lazyClass),
                  G(function () {
                    (!c || (t.complete && t.naturalWidth > 1)) &&
                      (c ? S(h) : $--, A(h));
                  }, !0);
              }),
              j = function (t) {
                ...
                ((!n && g) ||
                  ...
                  V(t, O.errorClass) ||
                  !V(t, O.lazyClass)) &&
                  ((e = U(t, "lazyunveilread").detail),
                  n && et.updateElem(t, !0, t.offsetWidth),
                  (t._lazyRace = !0),
                  $++,
                  a(t, e, n, s, i));
              },
              n = function () {
                if (!g) {
                  if (l.now() - e < 999) return void W(n, 999);
                  var t = tt(function () {
                    (O.loadMode = 3), i();
                  });
                  (g = !0),
            ...
            return {
              _: function () {
                (e = l.now()),
                  (L.elements = I.getElementsByClassName(O.lazyClass)),
                  ...
                  c("resize", i, !0),
                  r.MutationObserver
                    ? new MutationObserver(i).observe(B, {
                        childList: !0,
                        subtree: !0,
                        attributes: !0,
                      })
                    : (B[h]("DOMNodeInserted", i, !0),
                      B[h]("DOMAttrModified", i, !0),
                      setInterval(i, 999)),
                  c("hashchange", i, !0),
                  [
                    "focus",
                  ...
                  /d$|^c/.test(I.readyState)
                    ? n()
                    : (c("load", n), I[h]("DOMContentLoaded", i), W(n, 2e4)),
                  L.elements.length ? (t(), G._lsFlush()) : i();
              },
              checkElems: i,
              unveil: j,
            };
          ...
          et = (function () {
            var i,
              o = J(function (t, e, i, s) {
                ...
                if (
                  ...
                  for (
                    n = e.getElementsByTagName("source"), o = 0, a = n.length;
                    o < a;
                    o++
                  )
                    n[o].setAttribute("sizes", s);
              ...
              s = function (t, e, i) {
                ...
                n &&
                  ((i = a(t, n, i)),
                  (s = U(t, "lazybeforesizes", { width: i, dataAttr: !!e })),
                  s.defaultPrevented ||
                    ((i = s.detail.width) &&
                      i !== t._lazysizesWidth &&
                      o(t, n, s, i)));
            ...
            return {
              _: function () {
                (i = I.getElementsByClassName(O.autosizesClass)),
                  c("resize", e);
              },
              checkElems: e,
              updateElem: s,
    ...
    (h.Defaults = {
      ...
      (h.prototype.to = function (t, e) {
        var i,
          ...
          l = this.maximum();
        this.settings.loop
          ? (!this.settings.rewind && Math.abs(n) > a / 2 && (n += -1 * o * a),
            (i = (((((t = s + n) - r) % a) + a) % a) + r) !== t &&
              i - n <= l &&
              0 < i - n &&
              this.reset((s = (t = i) - n)))
              ...
              if (
                ...
                for (
                  ...
                  this.load(o / 2 + this._core.relative(n)),
                    o && r.each(this._core.clones(this._core.relative(n)), a),
                    n++;
              }
            }, this),
        }),
  ...
  (function (g) {
    g.fn.theiaStickySidebar = function (t) {
      var e, i;
      function s(t, e) {
        return (
          !0 === t.initialized ||
          (!(g("body").width() < t.minWidth) &&
            ((e = e),
            ((p = t).initialized = !0),
            g("head").append(
              g(
            ...
            e.each(function () {
              ...
              (t.sidebar = g(this)),
                (t.options = p || {}),
                (t.container = g(t.options.containerSelector)),
                ...
                0 == t.stickySidebar.length &&
                  ...
                  t.sidebar
                    ...
                    .remove(),
                  (t.stickySidebar = g("<div>")
                    .addClass("theiaStickySidebar")
                    .append(t.sidebar.children())),
              ...
              t.stickySidebar.css("padding-top", 1),
                ...
                0 == n
                  ? (t.stickySidebar.css("padding-top", 0),
                    (t.stickySidebarPaddingTop = 0))
                  : (t.stickySidebarPaddingTop = 1),
                0 == o
                  ? (t.stickySidebar.css("padding-bottom", 0),
                    (t.stickySidebarPaddingBottom = 0))
                  : (t.stickySidebarPaddingBottom = 1),
                (t.previousScrollTop = null),
                (t.fixedScrollTop = 0),
                d(),
                (t.onScroll = function (t) {
                  if (t.stickySidebar.is(":visible"))
                    if (g("body").width() < t.options.minWidth) d();
                    else {
                      if (t.options.disableOnResponsiveLayouts)
                        if (
                          t.sidebar.outerWidth(
                            "none" == t.sidebar.css("float")
                          ) +
                            50 >
                          t.container.width()
                        )
                      ...
                      var e,
                        ...
                        r,
                        l,
                        h = g(document).scrollTop(),
                        c = "static";
                      h >=
                        t.sidebar.offset().top +
                          (t.paddingTop - t.options.additionalMarginTop) &&
                        ((i = t.paddingTop + p.additionalMarginTop),
                        (o =
                          t.paddingBottom +
                          t.marginBottom +
                          p.additionalMarginBottom),
                        (n = t.sidebar.offset().top),
                        (s =
                          t.sidebar.offset().top +
                          ((a = t.container),
                          (r = a.height()),
                          a.children().each(function () {
                            r = Math.max(r, g(this).height());
                          }),
                          r)),
                        (e = 0 + p.additionalMarginTop),
                        (a =
                          t.stickySidebar.outerHeight() + i + o <
                          g(window).height()
                            ? e + t.stickySidebar.outerHeight()
                            : g(window).height() -
                              t.marginBottom -
                              t.paddingBottom -
                              p.additionalMarginBottom),
                        (i = n - h + t.paddingTop),
                        (o = s - h - t.paddingBottom - t.marginBottom),
                        (n = t.stickySidebar.offset().top - h),
                        (s = t.previousScrollTop - h),
                        "fixed" == t.stickySidebar.css("position") &&
                          "modern" == t.options.sidebarBehavior &&
                          (n += s),
                        "stick-to-top" == t.options.sidebarBehavior &&
                          (n = p.additionalMarginTop),
                        "stick-to-bottom" == t.options.sidebarBehavior &&
                          (n = a - t.stickySidebar.outerHeight()),
                        (n =
                          0 < s
                            ? Math.min(n, e)
                            : Math.max(n, a - t.stickySidebar.outerHeight())),
                        (n = Math.max(n, i)),
                        (n = Math.min(n, o - t.stickySidebar.outerHeight())),
                        (c =
                          ((o =
                            t.container.height() ==
                            t.stickySidebar.outerHeight()) ||
                            n != e) &&
                          (o || n != a - t.stickySidebar.outerHeight())
                            ? h + n - t.sidebar.offset().top - t.paddingTop <=
                              p.additionalMarginTop
                              ? "static"
                              : "absolute"
                            : "fixed")),
                        "fixed" == c
                          ? ((l = g(document).scrollLeft()),
                            t.stickySidebar.css({
                              position: "fixed",
                              width: u(t.stickySidebar) + "px",
                              transform: "translateY(" + n + "px)",
                              left:
                                t.sidebar.offset().left +
                                parseInt(t.sidebar.css("padding-left")) -
                                l +
                                "px",
                              top: "0px",
                            }))
                          ...
                          ? ((l = {}),
                            "absolute" != t.stickySidebar.css("position") &&
                              ...
                              (l.transform =
                                ...
                                "px)"),
                              (l.top = "0px")),
                            (l.width = u(t.stickySidebar) + "px"),
                            (l.left = ""),
                            t.stickySidebar.css(l))
                          : "static" == c && d(),
                        "static" != c &&
                          1 == t.options.updateSidebarHeight &&
                          t.sidebar.css({
                            "min-height":
                              t.stickySidebar.outerHeight() +
                              t.stickySidebar.offset().top -
                              t.sidebar.offset().top +
                              t.paddingBottom,
                          }),
...
function whiteLogo() {
  var t;
  "undefined" != typeof gh_white_logo &&
    ((t = '<img class="logo-image white" src="' + gh_white_logo + '">'),
    $(".logo").append(t));
}
...
function gallery() {
  document.querySelectorAll(".kg-gallery-image img").forEach(function (t) {
    var e = t.closest(".kg-gallery-image"),
      i = t.attributes.width.value,
      t = t.attributes.height.value;
    e.style.flex = i / t + " 1 0%";
  });
}
function author() {
